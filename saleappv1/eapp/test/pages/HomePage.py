...
class HomePage(BasePage):
    ...
    PRODUCT_BUTTON1 = (By.CSS_SELECTOR, '.container > div > div:nth-child(1) > div > div > button')
    PRODUCT_BUTTON2 = (By.CSS_SELECTOR, '.container > div > div:nth-child(2) > div > div > button')
